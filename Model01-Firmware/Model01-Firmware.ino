...
KEYMAPS(
  ...
  (___,                  Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   ___,                  Key_Y, Key_U, Key_I,     Key_O,         Key_P,         Key_Equals,
                         Key_H, Key_J, Key_K,     Key_L,         Key_Semicolon, Key_Quote,
   M(MACRO_BOUNCYHOUSE), Key_N, Key_M, Key_Comma, Key_Period,    Key_Slash,     Key_Minus,
   Key_RightShift, Key_LeftAlt, Key_Spacebar, Key_RightControl,
   ShiftToLayer(FUNCTION)),
...
#error "No default keymap defined. You should make sure that you have a line like '#define PRIMARY_KEYMAP_QWERTY' in your sketch"
  ...
  (___,                        Key_F1,           Key_F2,      Key_F3,     Key_F4,        Key_F5,           Key_CapsLock,
   ...
   M(MACRO_BOUNCYHOUSE_EMOJI), Consumer_Mute,          Consumer_VolumeDecrement, Consumer_VolumeIncrement, ___,             Key_Backslash,    Key_Pipe,
...
const macro_t *macroAction(uint8_t macroIndex, uint8_t keyState) {
  ...
  case MACRO_BOUNCYHOUSE:
    if (keyToggledOn(keyState)) {
      return Macros.type(PSTR("BouncyHouse"));
    }
    break;

  case MACRO_BOUNCYHOUSE_EMOJI:
    if (keyToggledOn(keyState)) {
      return Macros.type(PSTR(":bouncyhouse:"));
    }
    break;
...
KALEIDOSCOPE_INIT_PLUGINS(
  ...
  // https://github.com/keyboardio/Kaleidoscope-SpaceCadet
  SpaceCadet
);
